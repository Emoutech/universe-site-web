...
export default function ProductListView() {
  ...
  const notFound =
    ...
    (!productsStatus.loading && !dataFiltered.length);
  ...
  const handleEditRow = useCallback(
    (id: string) => {
      router.push(paths.demo.product.edit(id));
    },
    [router]
  );
  ...
  const handleViewRow = useCallback(
    (id: string) => {
      router.push(paths.demo.product.details(id));
    },
    [router]
  );
    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : "lg"}>
        <CustomBreadcrumbs
          heading="List"
          links={[
            { name: "Dashboard", href: paths.demo.root },
            {
              name: "Product",
